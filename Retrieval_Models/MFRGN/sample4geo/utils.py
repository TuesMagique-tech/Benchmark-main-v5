...
sys.path.append(r"D:/Acode/Benchmark-main-v5")
...
class Logger:
    def __init__(self, log_path):
        """初始化Logger: 打开日志文件，保存原始stdout引用。"""
        self.terminal = sys.stdout  # 保存原始控制台输出流
        self.log_file = open(log_path, 'w', encoding='utf-8')  # 打开日志文件（写模式）
